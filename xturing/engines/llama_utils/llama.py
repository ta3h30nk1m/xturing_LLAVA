...
# LLaMA model taken from Transformers library: https://github.com/huggingface/transformers
...
from transformers import CLIPVisionModel, AutoTokenizer, LlamaForCausalLM

#class LlamaForCausalLM(LlamaPreTrainedModel):
class Llava(LlamaPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.model = LlamaForCausalLM.from_pretrained("Aitrepreneur/vicuna-7B-1.1-GPTQ-4bit-128g")
