...
@dataclass
class Llava_InstructionDatasetMeta:
    infix_instruction: bool = False
    list_prompt_template: Optional[ListPromptTemplate] = None

class Llava_InstructionDataset(BaseDataset):
    config_name: str = "llava_instruction_dataset"
    ...
    def __init__(
        ...
        self._meta = Llava_InstructionDatasetMeta(
